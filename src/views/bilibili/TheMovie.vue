...
const getData = () => {
    // const url = `/pgc/season/index/result?st=2&style_id=-1&area=-1&release_date=-1&season_status=-1&order=0&sort=0&page=${data.pageNum}&season_type=2&pagesize=${data.pageSize}&type=1`
    const url = `https://api.codetabs.com/v1/proxy/?quest=${encodeURIComponent(`https://api.bilibili.com/pgc/season/index/result?st=2&style_id=-1&area=-1&release_date=-1&season_status=-1&order=0&sort=0&page=${data.pageNum}&season_type=2&pagesize=${data.pageSize}&type=1`)}`
    fetch(url)
