...
const getData = () => {
    // const url = `/pgc/season/index/result?area=-1&style_id=-1&release_date=-1&season_status=-1&order=0&st=7&sort=0&page=${data.pageNum}&season_type=7&pagesize=${data.pageSize}&type=1`
    const url = `https://api.codetabs.com/v1/proxy/?quest=${encodeURIComponent(`https://api.bilibili.com/pgc/season/index/result?area=-1&style_id=-1&release_date=-1&season_status=-1&order=0&st=7&sort=0&page=${data.pageNum}&season_type=7&pagesize=${data.pageSize}&type=1`)}`
    fetch(url)
